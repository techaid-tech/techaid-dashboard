...
function string2ArrayBuffer(s: string): ArrayBuffer | SharedArrayBuffer {
    s = s.replace(/[\u0080-\u07ff]/g,
        function (c: string) {
...
export function sha1_hash(bufferOrString: any): string {
    var source: ArrayBuffer | SharedArrayBuffer;
